...
const painPoints = [
  {
    ...
    description:
      'Your client says "around the middle somewhere, you know, after the thing." With scrubs, they click on the video and their comment lands on that exact frame. No timecode math. No guessing.',
  },
  {
    id: "02",
    title: "UPLOAD, WAIT, TRANSCODE, WAIT",
    description:
      "You just exported a 12GB ProRes and now you need to wait 20 minutes for it to process. scrubs uses Mux-powered playback — upload your file, get a link, share it. Seconds, not minutes.",
  },
  {
    id: "03",
  ...
  },
  {
    ...
    description:
      "The director, the producer, the client, the client's wife, the intern who somehow has opinions — they all need access. scrubs is $5/month flat. Invite literally everyone.",
  },
];
      ...
      <section className="px-6 py-24 md:py-32 border-b-2 border-[#1a1a1a] bg-[var(--background)]">
        <div className="max-w-5xl mx-auto">
          ...
          <p className="text-xl md:text-2xl font-medium text-[#888] max-w-3xl mb-12">
            ...
            a review tool that at least tells you where they meant. scrubs gives
      ...
      <section className="px-6 py-24 md:py-32 border-b-2 border-[#1a1a1a] bg-[#e8e8e0]">
        <div className="max-w-7xl mx-auto">
          ...
          <p className="text-lg text-[#888] font-medium text-center mb-16 max-w-2xl mx-auto">
            Every editor knows these problems. We built scrubs to fix them.
          </p>
