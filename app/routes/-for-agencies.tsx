...
const painPoints = [
  {
    ...
    description:
      'You hired them for a two-week project. Why are you paying a monthly seat fee? scrubs is $5/month total. Unlimited seats. Add your whole roster — full-timers, freelancers, that one intern who\'s "really good at Premiere."',
  },
  {
    id: "02",
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="mt-12 max-w-2xl">
            ...
            <p className="text-lg text-[#888] font-medium mt-4">
              scrubs is video review for creative teams. Unlimited seats. $5/month.
          ...
          <div className="flex flex-col lg:flex-row gap-16">
            <div className="lg:w-1/3">
              ...
              <p className="text-xl text-[#888] font-medium max-w-sm">
                Frame.io charges $19/user/month. scrubs charges $5/month total.
